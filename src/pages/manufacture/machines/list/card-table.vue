...
const onDeleteModal = (machine: IMachine, index: number) => {
        ...
        <tbody>
          ...
          <template v-if="!isLoading">
            <tr v-for="(machine, index) in machines" :key="index">
                  ...
                  <template #content>
                    <base-card class="py-1! px-2! text-sm">
                      <div class="flex flex-col">
                        <router-link :to="`/manufacture/machines/${machine._id}`">
                        ...
                        <base-button
                          ...
                          variant="text"
                          color="danger"
                          @click="onDeleteModal(machine, index)"
                        >
                          <div class="flex gap-2 w-full">
              ...
              <td>
                <router-link :to="`/manufacture/machines/${machine._id}`" class="text-blue">
                  {{ machine.code }}
                </router-link>
              </td>
              <td>{{ machine.name }}</td>
