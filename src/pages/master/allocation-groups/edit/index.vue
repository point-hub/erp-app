...
import { useUpdateAllocationGroupApi } from './update.api'

const route = useRoute()
const router = useRouter()
const authStore = useAuthStore()
const getAllocationGroupApi = useGetAllocationGroupApi()
const updateAllocationGroupApi = useUpdateAllocationGroupApi()
...
const onUpdate = async () => {
  ...
  const response = await updateAllocationGroupApi.send(
