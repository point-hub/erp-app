...
const getAllocationGroups = async () => {
  ...
  allocationGroups.value = response.data.data
  pagination.value = response.data.pagination
}
const rowMenuRef = ref()
const allocationGroups = ref<IAllocationGroup[]>()
...
const openMenu = (allocationGroup: IAllocationGroup, index: number) => {
...
<template>
  <div class="flex flex-col gap-4">
    <card-breadcrumbs />
    <base-card>
      <template #header>Allocation Groups</template>
      <div class="my-5 flex gap-2">
        <router-link to="/master/allocation-groups/create">
        ...
        <base-table>
          ...
          <tbody>
            ...
            <template v-if="!isLoading">
              <tr v-for="(allocationGroup, index) in allocationGroups" :key="index">
                <td>
                      ...
                      <base-card class="py-1! px-2! text-sm">
                        <div class="flex flex-col">
                          ...
                          <base-button
                            variant="text"
                            color="danger"
                            @click="openMenu(allocationGroup, index)"
                          >
                            <div class="flex gap-2 w-full">
