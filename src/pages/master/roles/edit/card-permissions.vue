...
const checkRows = (module: string, feature: string) => {
  ...
  permission.value[module][feature].approval = permission.value[module][feature].check
}
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.master.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.master ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.master[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.master[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.master[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.master[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.master[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.purchasing.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.purchasing ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.purchasing[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.purchasing[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.purchasing[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.purchasing[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.purchasing[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.sales.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.sales ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.sales[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.sales[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.sales[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.sales[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.finance.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.finance ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.finance[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.finance[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.finance[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.finance[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.finance[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.manufacture.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.manufacture ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.manufacture[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.manufacture[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.manufacture[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.manufacture[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.manufacture[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.inventory.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.inventory ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.inventory[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.inventory[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.inventory[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.inventory[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.inventory[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
            ...
            <tbody v-if="permission">
              <tr>
                ...
                <td>
                  ...
                  >
                    <base-checkbox v-model="permission.accounting.menu" class="-mr-2" />
                  </div>
                </td>
                <td></td>
                <td></td>
              ...
              <tr v-for="[key] in Object.entries(permission?.accounting ?? {})" :key="key">
                <template v-if="key !== 'menu'">
                  ...
                  <td>
                    ...
                    >
                      <base-checkbox v-model="permission.accounting[key].read" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.accounting[key].create" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.accounting[key].update" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.accounting[key].delete" class="-mr-2" />
                    </div>
                  </td>
                  <td>
                    <div
                    ...
                    >
                      <base-checkbox v-model="permission.accounting[key].approval" class="-mr-2" />
                    </div>
                  </td>
                </template>
              </tr>
