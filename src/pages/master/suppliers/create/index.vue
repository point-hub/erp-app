...
import { useCreateSupplierApi } from './create.api'
import { useForm } from './form'

const router = useRouter()
const form = reactive(useForm())
const authStore = useAuthStore()
const createSuppliersApi = useCreateSupplierApi()
...
const onSave = async () => {
  ...
  const response = await createSuppliersApi.send(form.data, form.errors)
  if (response?.inserted_id) router.push('/master/suppliers')
}
</script>
