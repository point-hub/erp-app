...
const itemCategories = ref<IItemCategory[]>()
...
watchDebounced(
  ...
  async () => {
    ...
    // call api
    const response = await getItemCategoriesApi.send(
...
const onDeleteModal = (itemCategory: IItemCategory, index: number) => {
...
<template>
  <base-card>
    ...
    <div class="my-5 flex gap-2">
      <router-link
        to="/master/item-categories/create"
                    ...
                    <base-card class="py-1! px-2! text-sm">
                      <div class="flex flex-col">
                        ...
                        <base-button
                          ...
                          variant="text"
                          color="danger"
                          @click="onDeleteModal(itemCategory, index)"
                        >
                          <div class="flex gap-2 w-full">
