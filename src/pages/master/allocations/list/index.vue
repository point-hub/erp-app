  ...
  const response = await axios.get('/v1/allocations', {
    params: {
      filter: {
        ...
        allocation_group: search.value.allocation_group
      },
      page: pagination.value.page
    }
  })
...
const openMenu = (allocation: IAllocation, index: number) => {
  rowMenuRef.value[index].toggle(false)
  deleteModalRef.value.toggleModal(true, {
    id: allocation._id,
    name: `[${allocation.code}] ${allocation.name}`
  })
}
  ...
  <div class="flex flex-col gap-4">
    ...
    <base-card>
      ...
      <div class="my-5 flex gap-2">
        <router-link to="/master/allocations/create">
                      ...
                      <base-card class="py-1! px-2! text-sm">
                        <div class="flex flex-col">
                          ...
                          <base-button
                            variant="text"
                            color="danger"
                            @click="openMenu(allocation, index)"
                          >
                            <div class="flex gap-2 w-full">
