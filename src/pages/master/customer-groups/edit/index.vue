...
onMounted(async () => {
  const response = (await axios.get(`/v1/master/customer-groups/${route.params.id}`)).data
...
const onUpdate = async () => {
  try {
    const response = await axios.patch(`/v1/master/customer-groups/${route.params.id}`, form.data)
