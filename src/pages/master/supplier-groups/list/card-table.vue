...
watchDebounced(
  ...
  async () => {
    ...
    // call api
    const response = await getSupplierGroupsApi.send(
...
const onDeleteModal = (supplierGroup: ISupplierGroup, index: number) => {
...
<template>
  <base-card>
    ...
    <div class="my-5 flex gap-2">
      <router-link
        to="/master/supplier-groups/create"
                    ...
                    <base-card class="py-1! px-2! text-sm">
                      <div class="flex flex-col">
                        ...
                        <base-button
                          ...
                          variant="text"
                          color="danger"
                          @click="onDeleteModal(supplierGroup, index)"
                        >
                          <div class="flex gap-2 w-full">
