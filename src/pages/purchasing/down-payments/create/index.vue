...
import { useCreateDownPaymentApi } from './create.api'
...
const createDownPaymentApi = useCreateDownPaymentApi()
...
const onSave = async () => {
  ...
  // api call
  const response = await createDownPaymentApi.send(form.data, form.errors)
